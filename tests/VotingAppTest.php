...
if (!file_exists(__DIR__ . '/../classes.php')) {
    throw new Exception('Required file classes.php not found.');
}
if (!file_exists(__DIR__ . '/../time_formatter.php')) {
    throw new Exception('Required file classes.php not found.');
}
...
class VotingAppTest extends TestCase {
    ...
    public function hasVoted($userId, $topicId) {
        try {
            ...
            // Debugging output
            if ($count == 0) {
                echo "No vote found for user_id: $userId and topic_id: $topicId\n";
            }
